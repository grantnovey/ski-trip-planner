...
/*
 * Documentation:
 * Modern navbar — https://app.subframe.com/e0dfc8dc556f/library?component=Modern+navbar_cba8555a-1e5a-4a57-8c3d-6ad67c2ef976
 */
...
>(function ModernNavbarRoot(
  ...
  return (
    <div
      className={SubframeUtils.twClassNames(
        "flex w-full flex-nowrap items-center gap-4 rounded-md border border-solid border-neutral-border bg-default-background shadow-md",
        className
      )}
      ref={ref}
      {...otherProps}
